...
**Alternative configs (Create to use in local testing):**
...
| `min_dist`     | float  | `0.01`     | Minimum distance between points in embedded space. `0.01` = tight clusters.          |
...
| `min_dist`                 | 0.01       | 0.025       | Slight separation for visualization     |
